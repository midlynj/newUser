        ...
        <div className="profile">
            ...
            <div>
                <ul className="header-menu horizontal-list">
                    ...
                    <li>
                        <Link to={UpdateInfo}>
                        <a className="header-menu-tab" href={UpdateInfo}><span className="icon entypo-cog scnd-font-color"></span>Settings</a>
                        </Link>
                        </li>
